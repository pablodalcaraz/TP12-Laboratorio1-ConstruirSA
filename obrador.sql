...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-05-2024 a las 22:35:50
...
(4, 30246516, 'Tolaba', 'Fernando', 1, 0),
(5, 25456778, 'Cuevas', 'Jaime', 1, 1),
(6, 32556456, 'Chipolis', 'Sergio', 1, 1);
...
(6, 'martillo', 'Stanley', 12, 1),
(7, 'destornillador', 'black&decker', 6, 1);
...
--
ALTER TABLE `movimiento`
  ADD CONSTRAINT `movimiento_ibfk_1` FOREIGN KEY (`id_empleado`) REFERENCES `empleado` (`id_empleado`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `movimiento_ibfk_2` FOREIGN KEY (`id_herramienta`) REFERENCES `herramienta` (`id_herramienta`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
